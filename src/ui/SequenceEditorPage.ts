module ui
{
    ...
    import ItemDescriptor = controls.SeqItemInfo;
    ...
    export class SequenceEditorPage
    {
        ...
        private playerControls: PlayerControls = new PlayerControls("playerControls", { MarkInOut: false, CreateMarkers: false, CreateSubClip: false, FullScreen: false });
        ...
        constructor()
        {
            ...
            {
                this.setListTitle(clipQuery.title);
            });

            this.navigatorPanel.onNavigationChanged((evt: NavigationEvent) =>
            {
            ...
            this.playerControls.onSetMarkIn((evt) =>
            {
                ...
                {
                    var movieTime = this.playerControls.getCurrentTime();
                    this.selectedItem.clipIn = movieTime;
                    ...
                    this.sequenceInOutsChanged(movieTime);
                }
            });
            ...
            this.playerControls.onSetMarkOut((evt) =>
            {
                ...
                {
                    var movieTime = this.playerControls.getCurrentTime();
                    this.selectedItem.clipOut = movieTime;
        ...
        private setListTitle(listTitle: string)
        {
        ...
        private sequenceInOutsChanged(newPlayheadTime: Timecode)
        {
    ...
    class TimelinePanel extends Panel
    {
        ...
        public sequenceInOutsChanged()
        {
            ...
            if (this.selectedItem) this.selectIndividualItem(this.selectedItem);
        }
    ...
    class ThumbnailLookup 
    {
        ...
        private static findThumbnailAtTime(thumbnails: Thumbnail[], time: number, callback: (thumbnailId: number) => void)
        {
            var thumbnailID: number = null;
