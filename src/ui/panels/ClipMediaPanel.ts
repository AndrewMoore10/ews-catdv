module ui.panels
{
    ...
    import LinkButton = controls.LinkButton;
    ...
    export class ClipMediaPanel extends Control
    {
        ...
        public setClip(clip: Clip, clipUID: string = null)
        {
        ...
        private playClip()
        {
            ...
            {
                var seqItems: SeqItemInfo[] = this.clip.seqItems.map((seqItem) =>
                {
                    return {
                ...
                (<SequencePlayer>this.videoPlayer).openSequence(seqItems, ServerSettings.useQuickTime,() =>
                {
                    ...
                    this.playerControls.show();
                    var editable = this.clip.isEditable;
                    this.playerControls.setClipAndPlayer(this.clip, this.videoPlayer, { MarkInOut: editable, CreateMarkers: editable, CreateSubClip: false, FullScreen: true });
                });
            }
        }
    }
    ...
    export class PlayerControls extends FocusPanel
    {
        ...
        private playPauseBtn: LinkButton;
        private markInBtn: LinkButton;
        private markOutBtn: LinkButton;
        private fullscreenBtn: LinkButton;
        private addEventMarkerBtn: LinkButton;
        private addRangeMarkerBtn: LinkButton;
        private createSubclipBtn: LinkButton;
        private videoPlayer: VideoPlayer;
        ...
        public setOptions(options: PlayerControlOptions)
        {
            this.options = options;
            this.renderControlButtons();
            this.updateButtons();
        ...
        private updateButtons()
        {
            ...
            if(this.addRangeMarkerBtn) this.addRangeMarkerBtn.setEnabled(validSelection);
            if(this.createSubclipBtn) this.createSubclipBtn.setEnabled(validSelection);
        }
