...
(function (logic) {
    ...
    var ClipManager = (function () {
        ...
        ClipManager.createSequence = function (name, useSelection, clips, callback) {
            // validate clips
            var illegalClip = clips.find(function (clip) { return ((clip.type != "clip") && (clip.type != "subclip") && (clip.type != "metaclip")); });
            if (illegalClip) {
        ...
        ClipManager.exportFCPXML = function (clips) {
            var query = { name: "cliplist", terms: [{
                        field: "clip.id",
                        op: "isOneOf",
                        params: clips.map(function (clip) { return clip.ID; }).join(","),
                        logicalOR: false,
                        logicalNOT: false,
                        ignoreCase: false
                    }] };
        ...
        ClipManager.getDownloadUrl = function (clip, originalMedia, proxyMedia, download) {
            ...
            if ((originalMedia && logic.ServerSettings.canDownloadOriginals && mediaPath && clip.media.isMediaAvailable)
                || (proxyMedia && logic.ServerSettings.canDownloadsProxies && proxyPath && (proxyPath !== mediaPath))) {
                ...
                url += "?download=" + download + "&type=" + (originalMedia && logic.ServerSettings.canDownloadOriginals ? "orig" : "proxy");
