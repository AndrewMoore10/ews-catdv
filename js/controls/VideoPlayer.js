...
(function (controls) {
    ...
    var HtmlVideoPlayer = (function (_super) {
        ...
        HtmlVideoPlayer.prototype.openMovie = function (url, aspectRatio, readyCallback, errorCallback) {
            ...
            this.endTime = null;
            this.playerInitialised = false;
            // In Chrome must set src='' before setting to another url. See - https://code.google.com/p/chromium/issues/detail?id=234779           
            try {
        ...
        HtmlVideoPlayer.prototype.supportsFullscreen = function () {
            return Boolean((this.videoElement.requestFullscreen)
        ...
        HtmlVideoPlayer.prototype.setCurrentTime = function (newTime, stateAfterSeek) {
            if (stateAfterSeek === void 0) { stateAfterSeek = PlayingState.Stopped; }
            if (this.isMoviePlayable()) {
    ...
    var QuickTimeVideoPlayer = (function (_super) {
        ...
        QuickTimeVideoPlayer.prototype.openMovie = function (url, aspectRatio, readyCallback, errorCallback) {
            ...
            this.readyTimer = new controls.Timer(100, function () { _this.firePlayerEvent(); });
            ...
            var html = "<object class='quicktimePlayer' classid='clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B'  "
                ...
                + "<param name='src' value='" + encodeURI(url) + "'/>"
                ...
                + " autoplay='false'"
                + " scale='ToFit'"
                + " name='" + this.playerId + "' src='" + encodeURI(url) + "' style='width:100%; height:" + height + ";'/>"
                + "</object>";
            ...
            controls.Timer.defer(Platform.isSafari() || Platform.isOldIE() ? 1000 : 0, function () {
                ...
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_begin", function (evt) { _this.onQuickTimeEvent("qt_begin", evt); });
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_canplay", function (evt) { _this.onQuickTimeEvent("qt_canplay", evt); });
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_error", function (evt) { _this.onQuickTimeEvent("qt_error", evt); });
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_pause", function (evt) { _this.onQuickTimeEvent("qt_pause", evt); });
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_play", function (evt) { _this.onQuickTimeEvent("qt_play", evt); });
                _this.bindPlugInEvent(_this.quicktimePlayer, "qt_ended", function (evt) { _this.onQuickTimeEvent("qt_play", evt); });
