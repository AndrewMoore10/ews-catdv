...
(function (ui) {
    ...
    (function (panels) {
        ...
        var LinkButton = controls.LinkButton;
        ...
        var ClipMediaPanel = (function (_super) {
            ...
            function ClipMediaPanel(element, playerControls) {
                ...
                this.$element.addClass("clipMediaPanel");
                //            this.css({
                //                "position": "relative",
                //            });
                this.imgPoster = new Image($("<img class='poster'>").appendTo(this.$element));
                this.imgPoster.css({
                    "display": "block",
                    "width": "100%"
                });
                ...
                this.playerPanel = new Panel($("<div class='player'>").appendTo(this.$element));
                this.playerPanel.css({
                    "display": "none",
                    "width": "100%"
                });
            }
            ClipMediaPanel.prototype.setClip = function (clip, clipUID) {
                if (clipUID === void 0) { clipUID = null; }
                ...
                if (this.clip != null) {
                    ...
                    if (newClip) {
                        ...
                        if (!hasDuration && proxyExt != null && (proxyExt == "jpg" || proxyExt == "png" || proxyExt == "gif")) {
                            this.imgPoster.setSourceUrl($catdv.getApiUrl("media/" + (clipUID ? clipUID : clip.media.ID)));
                        }
                        else {
                            this.imgPoster.setSourceUrl($catdv.getApiUrl("thumbnail/" + (clipUID ? clipUID : clip.posterID)));
                        }
                        ...
                        var editable = this.clip.isEditable;
                        this.playerControls.setClipAndPlayer(this.clip, this.videoPlayer, { MarkInOut: editable, CreateMarkers: editable, CreateSubClip: editable, FullScreen: true });
                    }
                }
                else {
            ...
            ClipMediaPanel.prototype.playClip = function () {
                ...
                if (this.clipType == "clip") {
                    ...
                    var url = $catdv.getApiUrl("media/" + (this.clipUID ? this.clipUID : this.clip.sourceMediaID) + "/" + proxyName + "?clipID=" + this.clip.ID);
                    this.videoPlayer.openMovie(url, this.clip.media ? this.clip.media.aspectRatio : null, function () {
                        ...
                        var editable = _this.clip.isEditable;
                        _this.playerControls.setClipAndPlayer(_this.clip, _this.videoPlayer, { MarkInOut: editable, CreateMarkers: editable, CreateSubClip: editable, FullScreen: true });
                    }, function (errorCode) {
                        _this.imgError.show();
                    ...
                    var seqItems = this.clip.seqItems.map(function (seqItem) {
                        return {
                            url: $catdv.getApiUrl("media/" + seqItem.clipMediaID + "/clip.mov?clipID=" + seqItem.seqID),
                    ...
                    this.videoPlayer.openSequence(seqItems, ServerSettings.useQuickTime, function () {
                        ...
                        _this.playerControls.show();
                        var editable = _this.clip.isEditable;
                        _this.playerControls.setClipAndPlayer(_this.clip, _this.videoPlayer, { MarkInOut: editable, CreateMarkers: editable, CreateSubClip: false, FullScreen: true });
                    });
                }
            };
        ...
        var PlayerControls = (function (_super) {
            ...
            function PlayerControls(element, options) {
                ...
                $(window).resize(function (evt) {
                    _this.playhead.setLimits(0, _this.timeline.getWidth() - 2);
                });
                this.playPauseBtn = new LinkButton("playPauseBtn");
            ...
            PlayerControls.prototype.renderControlButtons = function () {
                ...
                if (this.options.MarkInOut) {
                    ...
                    this.markInBtn = new LinkButton("markInBtn");
                    this.markInBtn.onClick(function (evt) { return _this.markInBtn_onClick(evt); });
                    this.markOutBtn = new LinkButton("markOutBtn");
                ...
                if (this.options.CreateMarkers) {
                    ...
                    this.addEventMarkerBtn = new LinkButton("addEventMarkerBtn");
                    this.addEventMarkerBtn.onClick(function (evt) { return _this.addEventMarkerBtn_onClick(evt); });
                    this.addRangeMarkerBtn = new LinkButton("addRangeMarkerBtn");
                ...
                if (this.options.CreateSubClip) {
                    ...
                    this.createSubclipBtn = new LinkButton("createSubclipBtn");
                ...
                if (this.options.FullScreen) {
                    ...
                    this.fullscreenBtn = new LinkButton("fullscreenBtn");
            ...
            PlayerControls.prototype.setOptions = function (options) {
                this.options = options;
                this.renderControlButtons();
                this.updateButtons();
            };
            ...
            PlayerControls.prototype.videoPlayer_playheadMoved = function (evt) {
                ...
                if (!this.playhead.isDragging()) {
                    if (this.playhead.getLimits().max < 0) {
                        this.playhead.setLimits(0, this.timeline.getWidth() - 2);
                    }
            ...
            PlayerControls.prototype.updateButtons = function () {
                var validSelection = this.clip && ((this.clip.in2 != null) && (this.clip.in2.secs != -1) && (this.clip.out2 != null) && (this.clip.out2.secs != -1));
                if (this.addRangeMarkerBtn)
                    this.addRangeMarkerBtn.setEnabled(validSelection);
                if (this.createSubclipBtn)
                    this.createSubclipBtn.setEnabled(validSelection);
            };
